  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          query.sql.Add
            ('select select prod.codigo,prod.produto, prod.unidade, prod.precovenda,prod.codbarra, prod.codgrupo, prod.codsubgrupo,prod.codmarca,prod.codoriginal,');
          query.sql.Add
        ...
        begin
          query.sql.Add
            ('select prod.codigo,prod.produto, prod.unidade, prod.precovenda,prod.codbarra, prod.codgrupo, prod.codsubgrupo,prod.codmarca,prod.codoriginal,');
          query.sql.Add
            ('prod.codfornecedor,estq.* from c000025 prod, c000100 estq where prod.codigo = estq.codproduto '
            + situacao);
        end
...
begin
  ...
  begin
    ...
    query.sql.Add
      ('prod.codfornecedor,estq.* from c000025 prod, c000100 estq where prod.codigo = estq.codproduto '
      + situacao + ' and upper(prod.codoriginal) like ''' + ansiuppercase(loc.text)
      + '%'' order by produto');
    query.open;
    GRID.setfocus;
  end;
