...
uses
  ...
  MidasLib, ACBrSocket, ACBrIBPTax, ACBrNCMs;
...
uses modulo, senha, cliente, xloc_pessoas,
  ...
  ManutencaoProduto, AtualizaNCM, AtualizaIBPT, IcmsUF, PartilhaICMS;
      ...
      begin
        ...
        begin
          ...
          if application.messagebox
            ...
            'para continua fecher o caixa do dia ' + qrcx.FIELDBYNAME('data').asstring
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if application.messagebox
          (Pchar('Foi Encontrada uma nova vers„o do Sistema GCS_Gerencial' + #13 +
...
begin
  ...
  if (timetostr(time) >= '23:55:00') and (timetostr(time) <= '24:00:00') then
  begin
