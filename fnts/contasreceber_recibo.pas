...
uses
  ...
  AdvGlowButton, Mask, RzEdit, RzSpnEdt, AdvReflectionImage, frxExportPDF;
    ...
    begin
      ...
      begin
        ...
        DOCUMENTO := FRMPRINCIPAL.texto_justifica
          (qrcontasreceber.FieldByName('DOCUMENTO').asstring, 10,
          ' ', 'D');
        VALOR := FRMPRINCIPAL.texto_justifica(FORMATFLOAT('###,###,##0.00',
          qrcontasreceber.FieldByName('VALOR_ATUAL').ASfloat), 12,
          ' ', 'E');
        CUPOM := FRMPRINCIPAL.texto_justifica
          (qrcontasreceber.FieldByName('NUMERO_CUPOM').asstring, 6,
          '0', 'E');
...
begin
  ...
  qrcontasreceber.CLOSE;
  qrcontasreceber.SQL.CLEAR;
  qrcontasreceber.SQL.ADD('select * from c000049 where situacao = 1 and codcliente = ''' +
                                            FRMMODULO.qrcliente.FieldByName('codigo').asstring +
                                            ''' order by data_vencimento, codigo');
  qrcontasreceber.open;
  ...
  while not qrcontasreceber.Eof do begin
    ...
    frmcontasreceber.qrcr_recibo.FieldByName('DATA_EMISSAO').asstring := qrcontasreceber.FieldByName('DATA_EMISSAO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODIGO').asstring := qrcontasreceber.FieldByName('CODIGO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('DATA_VENCIMENTO').asstring := qrcontasreceber.FieldByName('DATA_VENCIMENTO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('DOCUMENTO').asstring := qrcontasreceber.FieldByName('DOCUMENTO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('VALOR_ORIGINAL').asstring := qrcontasreceber.FieldByName('VALOR_ORIGINAL').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('VALOR_PAGO').asstring := qrcontasreceber.FieldByName('VALOR_PAGO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('VALOR_ATUAL').asstring := qrcontasreceber.FieldByName('VALOR_ATUAL').asstring;

    total := total + qrcontasreceber.FieldByName('VALOR_ATUAL').AsFloat;

    frmcontasreceber.qrcr_recibo.FieldByName('CODCEDENTE').asstring := qrcontasreceber.FieldByName('CODCEDENTE').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('TIPO').asstring := qrcontasreceber.FieldByName('TIPO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('VALOR_JUROS').asstring := qrcontasreceber.FieldByName('VALOR_JUROS').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('DATA_PAGAMENTO').asstring := qrcontasreceber.FieldByName('DATA_PAGAMENTO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODVENDEDOR').asstring := qrcontasreceber.FieldByName('CODVENDEDOR').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODCAIXA').asstring := qrcontasreceber.FieldByName('CODCAIXA').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODCLIENTE').asstring := qrcontasreceber.FieldByName('CODCLIENTE').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('VALOR_DESCONTO').asstring := qrcontasreceber.FieldByName('VALOR_DESCONTO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('SITUACAO').asstring := qrcontasreceber.FieldByName('SITUACAO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODVENDA').asstring := qrcontasreceber.FieldByName('CODVENDA').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('NOSSONUMERO').asstring := qrcontasreceber.FieldByName('NOSSONUMERO').asstring;
    frmcontasreceber.qrcr_recibo.FieldByName('CODREGIAO').asstring := qrcontasreceber.FieldByName('CODREGIAO').asstring;
  ...
  fxrecibo.LoadFromFile('C:\SQL_Gerencial\server\rel\f000078.fr3');
  fxrecibo.ShowReport;
