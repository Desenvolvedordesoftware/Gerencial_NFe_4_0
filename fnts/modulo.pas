...
uses
  ...
  ACBrBoletoFCFR, ACBrBase, ZSqlProcessor, MemDS, Uni; // NeoKeyUnit,frxExportImage,frxExportRTF,
...
type
  Tfrmmodulo = class(TDataModule)
    ...
    ZQuery3: TZQuery;
    qrIBPTDESCRICAO: TWideStringField;
    qrIBPTALIQESTADUAL: TFloatField;
    qrIBPTALIQMUNICIPAL: TFloatField;
