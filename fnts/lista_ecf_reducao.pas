...
begin
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\SQL_Gerencial\server\rel\f000092.fr3');
    FXNOTA.ShowReport;
  ...
  begin
    ...
    begin
      ...
      if combo_relatorio.Text = 'MAPA RESUMO ECF' then
        FXNOTA.LoadFromFile('\SQL_Gerencial\server\rel\f000140.fr3')
      else
        FXNOTA.LoadFromFile('\SQL_Gerencial\server\rel\f000140_1.fr3');
      FXNOTA.ShowReport;
    end
    else
    begin
