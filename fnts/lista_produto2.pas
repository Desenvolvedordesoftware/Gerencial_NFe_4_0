...
begin
  ...
  begin
    ...
    FRMMODULO.qrrelatorio.fieldbyname('LINHA1').ASSTRING :=
      'POSIÇÃO DE ESTOQUE';
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000184.fr3');
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000025.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000076.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000026.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000075.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000027.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000028.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000029.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000030.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000017.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000016.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000031.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000128.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000020.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000130.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000018.fr3');
    fxproduto.ShowReport;
    qrproduto.MasterSource := nil;
    qrproduto.MasterFields := '';
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000101.fr3');
    fxproduto.ShowReport;
    qrproduto.MasterSource := nil;
    qrproduto.MasterFields := '';
    qrproduto.IndexFieldNames := '';
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000102.fr3');
    fxproduto.ShowReport;
    qrproduto.MasterSource := nil;
    qrproduto.MasterFields := '';
    qrproduto.IndexFieldNames := '';
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000019.fr3');
    fxproduto.ShowReport;
    qrproduto.MasterSource := nil;
    qrproduto.MasterFields := '';
    qrproduto.IndexFieldNames := '';
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000142_1.fr3');
    fxproduto.ShowReport;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000142.fr3');
    fxproduto.ShowReport;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000142_3.fr3');
    fxproduto.ShowReport;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000142_2.fr3');
    fxproduto.ShowReport;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000098.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000103.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    FRMMODULO.qrrelatorio.fieldbyname('linha3').ASSTRING := 'PERÍODO: ' +
      ldataini_remarcado.Text + ' a ' + ldatafim_remarcado.Text;
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000190.fr3');
    fxproduto.ShowReport;
  end;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000143.fr3');
    fxproduto.ShowReport;
  ...
  begin
    ...
    fxproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000196.fr3');
    fxproduto.ShowReport;
  end;
