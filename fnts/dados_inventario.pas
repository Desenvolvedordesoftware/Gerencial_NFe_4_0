...
begin
  ...
  if FileExists('\SQL_Gerencial\server\bd\eDI.inf') then
  begin
    assignfile(txt, '\SQL_Gerencial\server\bd\eDI.inf');
    reset(txt);
...
begin
  ...
  frminventario.fXproduto.LoadFromFile('\SQL_Gerencial\server\rel\f000126.fr3');
