    ...
    inicia: { : INICIA VERIFICAÇÃO SE O PRODUTO ESTÁ PRONTO PARA RECEBER MOVIMENTAÇÃO - HISTORICO DE COMPRAS }
      ...
      begin
        ...
        begin { : CADASTRA O PRODUTO E ATUALIZA O CODPRODUTO NO QRITEM }
          CadastrarProduto(qritemCODLANCAMENTO.AsString,
            ...
            qritemCLASSIFICACAO_FISCAL.AsString, '102', '000',
      ...
      begin
        CadastrarProduto(qritemCODLANCAMENTO.AsString, qritemCODBARRA.AsString,
          ...
          qritemUN_FRACAO.AsString, qritemCLASSIFICACAO_FISCAL.AsString, '102',
          '000', qritemIPI_ALIQUOTA.ASFLOAT, qritemFRACAO.ASFLOAT);
...
begin
  ...
  begin
    ...
    QryCadastraProdutoCODGRUPO.Value := '000001';
    QryCadastraProdutoCODSUBGRUPO.Value := '000001';
    QryCadastraProdutoESTOQUEMINIMO.Value := 1;
    QryCadastraProdutoALIQUOTA.Value := 17;
    QryCadastraProdutoDATA_INVENTARIO.Value := date;
    QryCadastraProdutoCUSTO_INVENTARIO.Value := 0;
    QryCadastraProdutoESTOQUE_INVENTARIO.Value := 0;
    QryCadastraProdutoPISCOFINS.Value := 'N';
    QryCadastraProdutoINCIDENCIA_PISCOFINS.Value := 'NENHUMA';
    QryCadastraProdutoIAT.Value := 'T';
    QryCadastraProdutoIPPT.Value := 'T';
    QryCadastraProdutoSITUACAO_TRIBUTARIA.Value := 'T';
    QryCadastraProdutoORIGEM.Value := 0;
    QryCadastraProdutoDATA_REMARCACAO_VENDA.Value := date;
//    QryCadastraProdutoCEST.Value := CEST;
...
begin
  ...
  fximprime.LoadFromFile('\GCSISTEM\server\REL\F000197.fr3');
