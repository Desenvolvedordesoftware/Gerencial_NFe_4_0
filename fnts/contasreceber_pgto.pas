...
begin
  try
    ...
    frmcontasreceber.qrcontasreceber.SQL.ADD('select * from c000049 where codcliente = ''' +
    ...
    if frmcontasreceber.qrcontasreceber.RecordCount = 1 then begin
      ...
      if rdiferenca.VALUE < 0 then begin
        if Application.messagebox('A diferença será lançada como crédito?',
          'Atenção', mb_yesno + MB_DEFBUTTON2 + mb_iconquestion) = idyes then begin
      ...
      if (frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat < 0.02) and
         (frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat > (-0.02)) then begin
      ...
      while not frmcontasreceber.qrcontasreceber.Eof do begin
        if vvalor_pago1 > 0 then begin
          with frmcontasreceber do begin
            qrcontasreceber_pgto.insert;
            qrcontasreceber_pgto.FieldByName('codconta').asstring := frmcontasreceber.qrcontasreceber.FieldByName('codigo').asstring;
            qrcontasreceber_pgto.FieldByName('data').asdatetime := edata.DateTime;
            qrcontasreceber_pgto.FieldByName('valor_parcela').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat;
            if rjuros.VALUE <> 0 then begin
              qrcontasreceber_pgto.FieldByName('valor_juros').ASfloat := (frmcontasreceber.qrcontasreceber.FieldByName('VALOR_ATUAL').ASfloat * JUROS_A_MAIS) + frmcontasreceber.qrcontasreceber.FieldByName('VALOR_juros').ASfloat;
            end else begin
              qrcontasreceber_pgto.FieldByName('valor_juros').ASfloat := 0;
            end;

            if rdesconto1.VALUE <> 0 then begin
              qrcontasreceber_pgto.FieldByName('valor_desconto').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('VALOR_atual').ASfloat * (rdesconto1.VALUE / 100);
            end else begin
              qrcontasreceber_pgto.FieldByName('valor_desconto').ASfloat;
            end;

            if vgera_parcela = 0 then begin
              if vvalor_pago1 > 0 then begin
                if (vvalor_pago1 >= frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat) then begin
                  qrcontasreceber_pgto.FieldByName('valor_pago').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat;
              ...
              qrcontasreceber_pgto.FieldByName('valor_pago').ASfloat := qrcontasreceber_pgto.FieldByName('valor_pago').ASfloat + frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat;
            end;
            ...
            qrcontasreceber_pgto.FieldByName('CODCLIENTE').asstring := frmcontasreceber.qrcontasreceber.FieldByName('CODCLIENTE').asstring;
            if rcaixa.Checked then
          ...
          frmcontasreceber.qrcontasreceber.edit;
          if (vgera_parcela = 0) and (rdiferenca.VALUE <> 0) then begin
            if vvalor_pago > 0 then begin
              if rjuros.VALUE > 0 then begin
                if ((vvalor_pago + juros_desconto) >= frmcontasreceber.qrcontasreceber.FieldByName('restante').ASfloat) then begin
                  ...
                  if vvalor_pago < frmcontasreceber.qrcontasreceber.FieldByName('restante').ASfloat then begin
                    frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('restante').ASfloat - vvalor_pago;
                  end else begin
                    vvalor_pago := 0;
                    frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat := STRTOFLOAT(formatfloat('##########0.00',frmcontasreceber.qrcontasreceber.FieldByName('restante').ASfloat - frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat));
                  end;
                end;
              end else begin
                if (vvalor_pago >= frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat) then begin
                  frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat + frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat;
                  ...
                  frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat + vvalor_pago;
                  vvalor_pago := 0;
                  if frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat < 0 then begin
                    frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat := 0;
                    frmcontasreceber.qrcontasreceber.FieldByName('situacao').ASINTEGER := 2;
                    vvalor_pago1 := vvalor_pago1 - (frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat * (-1));
                  end else
                    frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('valor_original').ASfloat - frmcontasreceber.qrcontasreceber.FieldByName('valor_pago').ASfloat;
                end;
          ...
          if frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat < 0 then begin
            frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat := 0;
            frmcontasreceber.qrcontasreceber.FieldByName('situacao').ASINTEGER := 2;
          end;
      ...
      if vgera_parcela = 1 then begin
        if Application.messagebox('Será feito um lançamento do restante do débito!', 'Atenção',MB_okCANCEL + MB_ICONASTERISK) = IDok then begin
    ...
    try
      if Application.messagebox('Deseja imprimir o recibo?', 'Aviso', mb_yesno + mb_iconquestion) = idyes then begin
