...
begin
  ...
  if combo_tipo.ItemIndex = 0 then
    ...
    TIPO := ' and gerado_nfce = ' + QuotedStr('N')
  else
    TIPO := '';
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000120.fr3');
    fxvenda.ShowReport;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000158.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    qrvenda.SQL.Add('select * from c000048 where ' + periodo + SITUACAO +
      cliente + VENDEDOR + caixa + FORMA + TIPO + ' order by ' + ordem);
    qrvenda.Params.ParamByName('datai').asdatetime := DateEdit1.Date;
    qrvenda.Params.ParamByName('dataf').asdatetime := DateEdit2.Date;
    qrvenda.OPEN;
    ...
    if combo_forma.ItemIndex = 0 then
      fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000033.fr3')
    else
      fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000033_2.fr3');
  ...
  begin
    ...
    begin
      ...
      fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000032.fr3');
      fxvenda.ShowReport;
    end
    else
    begin
      ...
      FRMMODULO.qrrelatorio.fieldbyname('LINHA1').asstring :=
        'RESUMO DE VENDAS DE PRODUTOS/LUCRO';
      fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000032b.fr3');
      fxvenda.ShowReport;
    end;
  end;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000034.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\REL\F000036.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000037.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000038.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    FRMMODULO.qrrelatorio.fieldbyname('LINHA1').asstring :=
      'VENDAS/RECEBIMENTO';
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000099.fr3');
    fxvenda.ShowReport;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000099_1.fr3');
    fxvenda.ShowReport;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000039.fr3');
    fxvenda.ShowReport;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\f000181.fr3');
    fxvenda.ShowReport;
  end;
  ...
  begin
    ...
    fxvenda.LoadFromFile('\SQL_Gerencial\server\rel\F000183.fr3');
    fxvenda.ShowReport;
  end;
