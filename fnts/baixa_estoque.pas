...
begin
  ...
  begin
    ...
    begin
      NomeDoLog := 'C:\SQL_Gerencial\SERVER\Logs\TRANSFERENCIA_PRODUTOS' +
        DBEdit1.Text + '.txt';
...
begin
  ...
  if wwdbComboBox1.ITEMINDEX = 4 then
  begin
    fxorcamento.LoadFromFile('\SQL_Gerencial\server\rel\f000069_FILIAL.fr3');
    fxorcamento.ShowReport;
  end
  else
  begin
    fxorcamento.LoadFromFile('\SQL_Gerencial\server\rel\f000069_2.fr3');
    fxorcamento.ShowReport;
  end;
