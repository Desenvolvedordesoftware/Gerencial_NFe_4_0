...
begin
  ...
  begin
    ...
    fxos.LoadFromFile('\GCSISTEM\server\rel\f000066.fr3');
    //fxos.LoadFromFile('\GCSISTEM\server\rel\relatorio.rav');
    fxos.ShowReport;
  end;
  if RAMO = 3 then
  begin
    fxos.LoadFromFile('\GCSISTEM\server\rel\f000068.fr3');
    fxos.ShowReport;
  end;
end;
...
begin
  ...
  if RAMO = 1 then
  begin
    fxos.LoadFromFile('\GCSISTEM\server\rel\f000065.fr3');
    fxos.ShowReport;
  end;
  if RAMO = 3 then
  begin

    fxos.LoadFromFile('\GCSISTEM\server\rel\f000067.fr3');
    fxos.ShowReport;
  end;
end;
