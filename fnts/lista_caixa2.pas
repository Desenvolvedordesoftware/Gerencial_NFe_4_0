...
begin
  ...
  frmmodulo.qrrelatorio.FieldByName('valor10').Asfloat := qrsoma.fieldbyname('valor').asfloat +
    ...
    qrsoma.fieldbyname('valor_6').asfloat +
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\GCSISTEM\server\rel\f000071.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\GCSISTEM\server\rel\f000071_1.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\GCSISTEM\server\rel\f000072.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\GCSISTEM\server\rel\f000073.fr3');
    fxcAIXA.ShowReport;
  end;
