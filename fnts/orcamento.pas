...
begin
  ...
  impressora_venda := 'C:\SQL_Gerencial\TEXTE.TXT';
...
begin
  ...
  exp_PDF.DefaultPath := 'C:\SQL_Gerencial\Server\PDF\';
  exp_PDF.ShowDialog := FALSE;
  exp_PDF.ShowProgress := FALSE;
  exp_PDF.OverwritePrompt := FALSE;
  frxReport1.LoadFromFile('\SQL_Gerencial\server\rel\f000069.fr3');
...
begin
  ...
  TIdAttachmentFile.create(EmailCorpo.MessageParts,
    Tfilename('C:\SQL_Gerencial\Server\PDF\' + frmOrcamento.DBEdit1.text + '-' +
    frmOrcamento.enomecliente.text + '.pdf'));
