...
begin
  WinExec('C:\SQL_Gerencial\Server\Boleto.exe', SW_SHOW)
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ACBrBoleto1.DirArqRemessa := DirRemessa; // C:\SQL_Gerencial\server\cob\remessa
...
begin
  ...
  begin
    ...
    begin
      ...
      ACBrBoletoFCFR1.NomeArquivo := 'C:\SQL_Gerencial\server\pdf\' +
        NossoNumero + '.pdf';
