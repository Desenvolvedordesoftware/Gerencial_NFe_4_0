...
begin
  ...
  begin
    ...
    qrbuscacliente.sql.add('select * from c000051, c000007');
    qrbuscacliente.sql.add('WHERE c000051.codcliente = c000007.codigo and');
    qrbuscacliente.sql.add('upper(c000007.nome) LIKE ''%' + ANSIUPPERCASE(ecliente.Text) + '%''');
    qrbuscacliente.open;
  end;
