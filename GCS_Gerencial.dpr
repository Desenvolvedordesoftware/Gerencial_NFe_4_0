...
uses
  ...
  os_item_servico in 'fnts\OS\os_item_servico.pas' {frmOS_item_servico},
...
var
  Hand : THandle;
begin
  Hand := FindWindow('TApplication', 'GCS Gerencial 2018');
  ...
  if Hand = 0 then
     ...
     frmsplash.show;
     frmsplash.Update;
     Application.Title := 'GC SISTEM Gerencial 2018';
